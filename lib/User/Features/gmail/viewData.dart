...
class ViewAllEmails extends StatefulWidget {
  const ViewAllEmails({super.key});

  @override
  State<ViewAllEmails> createState() => _ViewAllEmails();
}

// This Page will show The User Donations
class _ViewAllEmails extends State<ViewAllEmails> {
    ...
    return Scaffold(
      floatingActionButton: currentUser != null
          ? FloatingActionButton(
              onPressed: () {
                Route route = MaterialPageRoute(builder: (_) => SendMail());
...
// accept functoin
  acceptCertficate(String certificateID) async {
    showDialog(
      context: context,
      builder: (_) =>
          const LoadingAlertDialog(message: "Accepting Certificate"),
    );
  ...
  rejectCertficate(String certificateID) async {
    showDialog(
      context: context,
      builder: (_) =>
          const LoadingAlertDialog(message: "Rejecting Certificate"),
    );
    await takeDrug.firebaseFirestore!
        .collection("users")
        .doc(certificateID)
