...
import 'package:intl/intl.dart' as Foramtt;
import 'package:take_drug/Common/config/config.dart';
import 'package:take_drug/services/notificationsServices.dart';

class editNotifications extends StatefulWidget {
  final int? notificaitonID;
  const editNotifications({super.key, required this.notificaitonID});

  @override
  State<editNotifications> createState() => _editNotifications();
}

class _editNotifications extends State<editNotifications> {
  ...
  gettingData() async {
    Stream<List<NotificationModel>> getNotificationsStream() async* {
      ...
      //     await AwesomeNotifications().get;
      ...
      //   setState(() {
      //     titleOfTheAlarm.text = element.content!.title!;
      //   });
      // }
      // await NotificationService.updateNOtifications(
      //   id: widget.notificaitonID!,
      //   bigPicture: ImageUrl,
