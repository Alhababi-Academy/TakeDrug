...
class editMedicalInformaitno extends StatefulWidget {
  final String ID;
  const editMedicalInformaitno({super.key, required this.ID});

  @override
  State<editMedicalInformaitno> createState() => _editMedicalInformaitno();
}

class _editMedicalInformaitno extends State<editMedicalInformaitno> {
